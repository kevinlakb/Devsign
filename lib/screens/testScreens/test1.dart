        ...
        child: Column(
          children: [
            ...
            SizedBox(
              ...
              child: Center(
                child: Text(
                  '¿En qué momento del día prefieres estudiar?',
                ...
                children: [
                      ...
                      child: InkWell(
                        child: Ink.image(
                          image: const AssetImage(
                              'assets/images/test1/manana.png'),
                          height: _width / 2,
                          width: _width / 2,
                          fit: BoxFit.cover,
                        ),
                  ...
                  Positioned(
                      ...
                      child: InkWell(
                        child: Ink.image(
                          image:
                              const AssetImage('assets/images/test1/dia.png'),
                          height: _width / 2,
                          width: _width / 2,
                          fit: BoxFit.cover,
                        ),
                  ...
                  Positioned(
                      ...
                      child: InkWell(
                        child: Ink.image(
                          image:
                              const AssetImage('assets/images/test1/tarde.png'),
                          height: _width / 2,
                          width: _width / 2,
                          fit: BoxFit.cover,
                        ),
                  ...
                  Positioned(
                      ...
                      child: InkWell(
                        child: Ink.image(
                          image:
                              const AssetImage('assets/images/test1/noche.png'),
                          height: _width / 2,
                          width: _width / 2,
                          fit: BoxFit.cover,
                        ),
